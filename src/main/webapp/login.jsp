			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<!-- img src="${ctx }/resources/images/logo.png"/> --> <br/> <br/>
							</h1>
						</div>
										...
										<form id="loginform" name="loginform"
											...
											<fieldset>
												...
												<span class="block input-icon input-icon-right"> 
													<input name="accountName" id="accountName" type="email" class="form-control" placeholder="邮箱" value="admin@webside.com"/><!-- 超级管理员用户名：admin@webside.com-->
													<i class="ace-icon fa fa-user"></i>
												</span>
												</label> 
												<label class="block clearfix"> 
												<span class="block input-icon input-icon-right"> 
													<input name="password" id="password" type="password" class="form-control" placeholder="密码" value="admin123"/><!-- 超级管理员密码： admin123-->
													<i class="ace-icon fa fa-lock"></i>
												</span>
												</label>
												<!-- 验证码生成Java控制器类：IndexController -->
												<label class="block clearfix"> 
													<input id="captcha" name="captcha" type="text" class="form-control" placeholder="验证码" style="width:60%;float:left;" value="1234"/>
