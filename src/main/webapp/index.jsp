...
<!-- ECharts图 -->
<script src="${ctx }/resources/js/echarts/echarts.js" type="text/javascript"></script>
<!-- 引入 vintage 主题 -->
...
Ext.Loader.setConfig({enabled:true});
	...
	Ext.onReady(function() {
		...
		ExtContainer = Ext.create('Ext.container.Container', {
			width : '98%',
			layout : 'fit',
			autoScroll : true,
			items : []
		...
		<div class="footer">
			<div class="footer-inner">
				...
				<div class="footer-content">
					<span class="bigger-120"> <span class="blue bolder">JMRT</span>
